...
(function () {
    ...
    var init = function (us) {
        ...
        settings = {
            ...
            whiteKeyColour: user_settings.whiteKeyColour || '#303030',
            blackKeyColour: user_settings.blackKeyColour || '#303030',
    ...
    var styleWhiteKey = function (key) {
        ...
        key.el.style.borderRadius = '4px 4px 5px 5px';
    ...
    var styleBlackKey = function (key) {
        ...
        key.el.style.borderRadius = '3px 3px 3px 3px';
    };
